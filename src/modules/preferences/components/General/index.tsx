    ...
    return (
        <div className="general-container h-100">
            ...
            <p className="about-text">
                ...
                <span>$ [What do I do]</span>I&#39;m overseeing full application
                ...
                <br />
                <span>$ [Code + Unit Testing === Good Quality Code]</span>I
                ...
                <br />
                <span>$ [DRY w/ Design Patterns]</span>I believe that applying
                ...
                <br />
                <span>$ [Mentor]</span>I enjoy mentoring others, setting
            ...
            <p className="about-text">
                ...
                <code>
                    [GCC 4.2.1 Compatible Apple LLVM 9.0.0 (clang-900.0.31)] on
                    darwin
                </code>
                <code>
                ...
                <code>
                    A Cloud Architect & Web Development Enthusiast. Working as a
                    Full Stack Developer.
                </code>
                <span>$</span> echo &#34;This is not really a terminal (It&#39;s
                just HTML+CSS)&#34;
            </p>
            <p className="lead">So far</p>
            <p className="about-text">
                <code># giwoogustavolee @ Giwoo-MacBook-Pro in ~</code>
                <span>$ [Web Development]</span> 8+ years advancing in the IT
